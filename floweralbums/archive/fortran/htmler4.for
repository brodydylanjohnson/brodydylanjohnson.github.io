...
C  WRITING HTML FILE FOR ONE PAGE (with TWO PHOTOS on it)
     ...
     $             'href="../htmlfiles/album.css" />'
        write(4,*) '<script src="../htmlfiles/hotchocolate.js">',
     $             '</script>'
        write(4,*) '</head>'
        write(4,*) '<body>'
 ...
 21     continue
        write(4,*) '<br>'
        write(4,*) '<a class="bj2" href="./index.html">'
        write(4,*) 'Cover</a>---<a class="bj2" href="./alb'
     $             // an // 'toc.htm">Contents</a>'
        write(4,*) '</td>'
...
C  WRITE FIRST PHOTO SOLO PAGE
        ...
        write(4,*) '<link rel="stylesheet" type="text/css"',
     $             'href="../htmlfiles/album.css" media="all" />'
        write(4,*) '<link rel="stylesheet" type="text/css"',
     $             'href="../htmlfiles/print.css" media="print" />'
        write(4,*) '<script src="../htmlfiles/hotchocolate.js">',
     $             '</script>'
        write(4,*) '</head>'
        write(4,*) '<body>'
